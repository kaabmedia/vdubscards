...
const DEFAULTS: FaqPageData = {
  ...
  items: [
    ...
    { question: "Do you ship internationally?", answer: "Yes. We ship within the EU and worldwide. Delivery times and any customs duties depend on your region and carrier processing." },
