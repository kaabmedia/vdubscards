        ...
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 py-5 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              { src: "/betaalmethoden/mastercard.svg", alt: "Mastercard" },
              { src: "/betaalmethoden/paypal.svg", alt: "PayPal" },
              { src: "/betaalmethoden/Bancontact_logo.svg.png", alt: "Bancontact" },
              { src: "/betaalmethoden/ideal-logo-1024.png", alt: "iDEAL" },
              { src: "/betaalmethoden/eps-logo-color.png", alt: "EPS" },
              { src: "/betaalmethoden/klarna.svg", alt: "Klarna" },
            ].map(({ src, alt }) => (
              <div
                key={alt}
                className="flex h-7 w-12 items-center justify-center rounded border border-gray-200 bg-white px-1.5 py-1"
              >
                <Image
                  src={src}
                  alt={alt}
                  width={40}
                  height={24}
                  className="h-5 w-full object-contain opacity-80"
                />
              </div>
            ))}
          </div>
